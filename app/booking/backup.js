  ...
  function initializeAutocomplete() {
    ...
    autocomplete.addListener('place_changed', () => {
      ...
      place.address_components.forEach((comp) => {
        const cType = comp.types[0];
        switch (cType) {
          case 'street_number':
            addressData.street_number = comp.long_name;
            break;
          case 'route':
            addressData.route = comp.long_name;
            break;
          case 'locality':
            addressData.locality = comp.long_name;
            break;
          case 'administrative_area_level_1':
            addressData.state = comp.short_name;
            break;
          case 'postal_code':
            addressData.postal_code = comp.long_name;
            break;
        }
      });
